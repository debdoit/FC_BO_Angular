...
@Component({
  selector: 'app-createbclogin',
  templateUrl: './createbclogin.component.html',
  styleUrls: ['./createbclogin.component.css']
})
export class CreatebcloginComponent implements OnInit {
